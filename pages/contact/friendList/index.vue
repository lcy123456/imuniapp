<template>
	<view class="friend_list_container">
		...
		<view class="search_bar_wrap">
			<u-search class="search_bar" shape="square" placeholder="搜索好友" :showAction="false" disabled @click="toSearch" />
		</view>

		<choose-index-list v-if="getIndexData.dataList.length > 0" @itemClick="userClick" :height="`${listHeight}px`" :indexList="getIndexData.indexList"
